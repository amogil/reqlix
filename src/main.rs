...
impl RequirementsServer {
    ...
    fn handle_insert_requirement(params: InsertRequirementParams) -> String {
        ...
        // Step 3: Validate title uniqueness (G.IR.3 step 3)
        ...
        // Step 6: Return result (G.IR.3 step 6, G.IR.5)
    ...
    fn handle_update_requirement(params: UpdateRequirementParams) -> String {
        ...
        // Step 3: Determine new title (G.UR.3 step 3)
        ...
        // Step 4: Validate title uniqueness (G.UR.3 step 4)
        ...
        // Step 6: Return result (G.UR.3 step 6, G.UR.5)
        Self::json_success(RequirementFull {
            index: params.index,
            title: new_title,
            text: params.text,
